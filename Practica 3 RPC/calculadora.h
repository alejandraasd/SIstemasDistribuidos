...
#define CALCULADORA_PROG 0x20000003
#define UNO 1
...
extern int calculadora_prog_2_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define resta 2
extern  int * resta_2();
extern  int * resta_2_svc();
extern int calculadora_prog_2_freeresult ();
#endif /* K&R C */
#define TRES 3
...
extern int calculadora_prog_3_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define multiplicacion 3
extern  int * multiplicacion_3();
extern  int * multiplicacion_3_svc();
extern int calculadora_prog_3_freeresult ();
#endif /* K&R C */
#define CUATRO 4
...
extern int calculadora_prog_4_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define division 4
extern  int * division_4();
extern  int * division_4_svc();
extern int calculadora_prog_4_freeresult ();
#endif /* K&R C */
